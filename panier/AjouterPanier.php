...
//inclure la page de connexion
 ...
 //récupération de l'id dans le lien
  if(isset($_GET['id'])){//si un id a été envoyé alors :
    ...
    if(isset($_SESSION['restaurant'][$id])){// si le produit est déjà dans le panier
        $_SESSION['restaurant'][$id]++; //Représente la quantité 
    }else {
        //si non on ajoute le produit
        $_SESSION['restaurant'][$id]= 1 ;
    }
